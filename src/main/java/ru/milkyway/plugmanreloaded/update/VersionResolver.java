...
public final class VersionResolver {
    ...
    private RemoteVersion pickNewest(List<RemoteVersion> versions) {
    ...
    private boolean isKnownRemoteVersion(String version, List<RemoteVersion> versions) {
        if (versions == null) {
            return false;
        }
    ...
    private boolean isNewerThanInstalled(PluginIdentity identity, RemoteVersion candidate, String effectiveInstalled) {
        String remote = candidate.versionNumber();
        if (remote == null || remote.isBlank()) {
            return false;
        }
